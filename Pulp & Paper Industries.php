...
<body>
  ...
  <div class="" id="sub-about">
    ...
    <h1 class="mb-5">Starch from the glue operations and fine fibre debris are frequently found in the wastewater from the pulp and paper industries.</h1>
    <p>Wacts has a lot of knowledge working with the maker of corrugated cardboard, Visy, and can efficiently evaluate wastewater flow and composition data to help with the optimum plant design for your company. <br> <br>
        For your pulp and paper industry, WACTS provides a variety of items that may be used to create a wastewater treatment plant that is appropriate for the job. Our engineers carefully examine your present wastewater after initial conversations with your team using extensive jar testing and chemical analysis. The proposed design is then given a sophisticated digital 3D modelling by WACTS so that you may see and comprehend the system before installation. <br> <br>
    </p>
