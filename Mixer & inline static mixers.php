...
<body>
  ...
  <div class="" id="sub-about">
    ...
    <p>There is an increasing demand for accurate and fast chemical dosing in  drinking water treatment. Applications such as disinfection, flocculation, fluorination, lead solubility, taste and odor control, pH correction, turbidity and ozonation  require precise dosing of chemicals. <br> <br>
        This not only requires precise dosing of chemicals to meet process requirements and stringent residue levels, but also performance when operating under varying flow conditions. Therefore, it is necessary to reduce the process time and  ensure that all analyzer/sampling probes measure representative samples after chemical dosing. <br><br>
       To assist in this process, WACTS in-line water treatment mixers can be supplied complete with chemical injection lances to direct chemicals to the heart of the mixer to optimize mixer performance. . <br><br>
        The in-line mixing and proper dosing of these chemicals has a fundamental impact on all stages of the treatment process and ultimately on the entire process. High levels of mixing and processing times are not provided. Static in-line mixers or in-line mixers provide the required degree of mixing and achieve optimal chemical dosing. This saves chemicals, improves process performance, and allows it to operate under a wide range of conditions and flows encountered in today's process.
    </p>
    <h1 class="mb-5 mt-5">INCLINE STATIC MIXER </h1>
    <p>Chemical mixing  has a major impact on every stage of the water treatment process. What plants have found is that a high degree of mixing  for the required conditions has not been achieved. <br>
        Static mixers provide continuous mixing and blending of all  water and wastewater treatment chemicals. Add flocculants, neutralizers, pH adjusters, and disinfectants  to the water stream and mix. <br>
        A static channel mixer allows for optimal mixing to deliver the right treatment.
    </p>
    <img class="w-100" src="images-2/5.png" alt="">
    <h1 class="mb-5 mt-5">OZONE WITHIN THE WATER TREATMENT PLANTS </h1>
    <p>With modern  water treatment advances, the use of strong oxidants such as ozone and AOP  (Advanced Oxidation Process) processes is not uncommon. Ozone is a strong oxidizing compound that, when  added to drinking water, rapidly oxidizes substances such as organics, iron and manganese. In addition, it is a highly effective disinfectant against bacteria and viruses. Ozone is highly unstable and  has a short lifetime. Therefore, it is important to mix and disperse the ozone  into the water as quickly as possible. WACTS static mixers and gas dispersion systems are ideally suited for this application and  are installed in many installations around the world. <br><br>

        Static mixers are gaining in popularity because, unlike agitated tanks, they thoroughly and completely mix the entire water stream and chemicals  in a relatively short  time. The energy required  for mixing comes from the main water stream. The resulting pressure drop is very small and depends on the operating conditions and  chosen mixer design. WACTS has extensive experience in designing and selecting suitable mixers for calculated pressure drops within acceptable limits.
    </p>
</div>
  </div>
