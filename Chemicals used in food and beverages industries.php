...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg "id="nav">
    ...
    <div class="callout">
      <h1 class="text-light sub-callout">Chemicals used in food and <br> beverages industries</h1>
  ...
  <div class="" id="sub-about">
    ...
    <p>The importance of water treatment in the food industry stems from the need to remove the presence of microorganisms. Water used for cooking or specially applied to  food must be of potable and good quality to avoid deterioration of any kind. These include the lack of dissolved minerals that make the water too hard or change its taste. <br> <br>
        Production water makes up the bulk of the liquids in the food industry, so water must be treated to achieve flavor goals. High purity often requires more water treatment than is necessary to  meet drinking water requirements. <br> <br>
    </p>
    <h1 class="mb-5 mt-5">BOTTLING PURIFICATION PROCESS</h1>
    <p>Beverage bottling usually begins with city tap water, which is supplied directly from the facility's city water source. Such tap water is perfectly drinkable, but usually has some degree of hardness or heavy metal deposits  (usually from the pipes that carry it) that affect its taste. Water softeners and reverse osmosis are great for making pure drinking water. <br><br>
        Once a beverage manufacturer takes a large sample, or “blank slate,” of purified water,  they typically start creating their own blends of minerals, metals, carbon dioxide (“fizz” in soda), and sugar. , syrups and food coloring to create the soft drinks  we know and love. Once this solution is thoroughly mixed, it is packaged in sealed bottles or cans and shipped to its destination. Alcoholic beverages go through a similar process, but are usually baked with yeast and some form of grain or fruit is added to make the alcohol.  of companies are doing it on a small scale.
    </p>
    <h1 class="mb-5 mt-5">REVERSE OSMOSIS</h1>
    <p>The reverse osmosis purification process uses a semi-permeable membrane  to remove ions and unwanted particles. This process removes both chemicals and bacteria, resulting in safe drinking water  for food and beverage production. Permeable membranes filter contaminants through a process called size exclusion. This prevents particles of a certain size from passing through.
    </p>
    <h1 class="mb-5 mt-5">Ion exchange</h1>
    <p>When contaminants dissolve in water, they shape ions. During ion change (IE) remedy, undesirable contaminants are eliminated from the water and changed with a non-dangerous substance. Ions may be both effective or negative, and the alternative substance have to have the identical kind of electric charge. Keep in thoughts that ion change is a wide remedy and may take away severa contaminants — inclusive of useful ones.
    </p>
    <h1 class="mb-5 mt-5">Carbon filtration</h1>
    <p>When contaminants dissolve in water, they shape ions. During ion change (IE) remedy, undesirable contaminants are eliminated from the water and changed with a non-dangerous substance. Ions may be both effective or negative, and the alternative substance have to have the identical kind of electric charge. Keep in thoughts that ion change is a wide remedy and may take away severa contaminants — inclusive of useful ones.
    </p>
    <h1 class="mb-5 mt-5">Deaeration</h1>
    <p>Water with dissolved oxygen left untreated can cause severe corrosion of metal equipment. Aeration is a method of removing this dissolved oxygen  and other gases  from  water. Steam is directed to the bottom of the aerator where it combines with water. Then heat the water  until the gas dissolves and escapes.
    </p>
    <h1 class="mb-5 mt-5">Settling</h1>
    <p>Sedimentation systems use tanks to remove suspended solids from water. These particles, which are denser than  water, fall to the bottom of the tank. Common contaminants removed by sedimentation include grease, hair, sand, sand, wood, bottles, and dirt. The latter, which accumulates at the bottom of the suspension tank, must be emptied regularly. 
    </p>
    <h1 class="mb-5 mt-5">UV disinfection </h1>
    <p>UV (ultraviolet) rays emanating from the sun are invisible to the naked eye and are an effective water treatment option due to their germicidal properties. It can disinfect water from bacteria, viruses and even protozoa. UV light is used in the United States to purify drinking water and is used commercially in the pharmaceutical, cosmetic, beverage, and electronics industries. <br> <br>
        Water treatment processes are important to food and beverage processors, whether using methods such as reverse osmosis or UV disinfection. This treatment not only protects the equipment and maintains a high quality product, but  also prevents chemicals from contaminating freshwater systems.
    </p>
</div>
  </div>
