...
Chemicals dosing Pumps
  ...
  <div class="" id="sub-about">
    ...
    <p>A dosing pump, which is a positive displacement pump, is used to inject chemicals or other substances into a stream of water, gas, or steam. Dosing pumps, which are typically small, deliver very precise flow rates for maximum control. They are the central components of an integrated dosing system  for  automatic distribution of chemicals. This dosage definition applies to a wide variety of applications and industries, from wastewater treatment to food processing.
    </p>
    <h1 class="mb-5 mt-5">HOW DOES IT WORK?</h1>
    <p>A metering pump draws a metered amount of liquid into its chamber and injects the chemical into a tank or tube containing the liquid to be dosed. Driven by an electric motor or  air actuator, it has a controller that turns the pump on and off to regulate flow. Some models include more advanced control systems.
    </p>
    <h1 class="mb-5 mt-5">components </h1>
    <p>The main components of the dosing pump include: <br> <br>

        Chemical Container or Tank - Contains the product to be dosed. <br>
        Pumps - vary in material and size. Consists of inlet, suction line and metering line.  <br>
        Injector – A one-way valve through which chemicals are injected into the product. Overcome the pressure in the tube and allow the chemicals to flow into the liquid. <br>
        Foot valve - A one-way valve attached to the suction line. Place in the product drum to keep the pump primed.  <br>
        Dosing line - rigid pipe or reinforced hose;  PE, PVC or stainless steel can be used for high pressure applications. <br>
        Control system - guarantees accuracy. Toggle on and off at specific times. It can be anything from a simple flow switch or timer to his SCADA central control system for various sensors and the ability to integrate into  larger systems. <br>
    </p>
    <img class="w-100 my-5" src="images-2/4.png" alt="">
    <h1 class="mb-5 mt-5">Types of Dosing Pumps </h1>
    <p>These four dosing pumps are designed for different pressures, chemicals and applications. They differ in pump action and mechanism. <br> <br>

        Diaphragm pumps (metering injection)  use diaphragms, pistons, and valves at both the inlet and outlet t o fill and empty chambers. Retracting the plunger fills the chamber and injects a specified amount of chemical  at a preset rate (usually a percentage of the maximum flow rate). Certain pump models are suitable for variable dosing rates.  <br>
        Diaphragm pumps (pulse injection)  also use a diaphragm mechanism, but instead of a constant flow, a solenoid  takes  the chemical and injects it in a pulsed fashion. Flow rate is the  time between pulses. Accuracy is inferior to fixed injection pumps, but the structure is simple  and inexpensive. <br>
        Lobe pump is capable of pumping a certain amount of fluid through a meshed impeller. Not as accurate as  diaphragm pumps and  only suitable for high viscosity liquids lubricated to minimize wear. Not designed for low flow rates as accuracy is difficult to obtain. <br>
        Peristaltic pumps are highly accurate in dosing. Fluid is passed through a flexible curved tube, and  flow is controlled by rollers that move through an outer mechanical arm. This forces the  product in the tube into the dosing tube and the main liquid flow. <br>
    </p>
</div>
  </div>
