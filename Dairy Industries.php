...
<body>
  ...
  <div class="" id="sub-about">
    ...
    <h1 class="mb-5">The presence of whey as a common by-product of the milk and cheese manufacturing processes means dairy wastewater treatment can be challenging.</h1>
    <p>The majority of food producers want to remove fats, oils, and grease (FOG) and suspended particles (SS) from their effluent. In the dairy business, biological treatment techniques could be needed to eliminate the soluble lactose and proteins that contribute to the levels of BOD and chemical oxygen demand (COD) in dairy effluent. <br> <br>
    </p>
    <p>WACTS has a depth of information in the dairy sector and can build a dairy wastewater treatment facility specifically to satisfy legal criteria. <br> <br>
        Following examination of your industrial processes, wastewater patterns, and the local authority discharge regulations, we develop the most affordable and useful solution for you. This might entail just suggesting partial flow treatment, whey collection and discharge, physical separation to get rid of the related suspended materials that contributes to the BOD, or a complete biological treatment solution. <br> <br>
    </p>
</div>
  </div>
