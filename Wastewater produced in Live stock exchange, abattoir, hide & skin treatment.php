  ...
  <nav class="navbar fixed-top navbar-expand-lg " id="nav">
    ...
    <div class="callout">
      <h1 class="text-light sub-callout">
        Industrial WasteWater <br> Treatment  </h1>
    </div>
  </section>
  <div class="" id="sub-about">
    <div style="padding: 150px 12px;" class="container">
    <h1 class="mb-5">Multiple markets use industrial wastewater systems.</h1>
    <p>For a firm to succeed, compliance-driven wastewater management is essential. Process wastewater is a byproduct of only few industries' industrial processes. WACTS has handled a wide range of wastewaters of various strengths, from washwater to boiler blowdowns. The engineers at WACTS have a wealth of knowledge in the wastewater sector and a strong desire to comprehend the chemistry of the wastewater and the best industrial wastewater system to solve the issue. <br><br>
        Because of their adaptability and efficiency, WACTS's solutions enable the construction of a distinctive industrial wastewater system for the majority of applications. The overall treatment plant created by our team of engineers will give a comprehensive solution for your industrial wastewater demands, whether it be utilising our technology, conventional methods mixed with creative, inventive engineering, or one of the many other solutions on the market. <br> <br>
        Our engineers can guarantee a design that complies with the specifications set out by your local council since they have a thorough grasp of the chemistry of difficult wastewaters. A cost-effective and efficient industrial wastewater system is crucial since discharge regulations are becoming more strict and the expenses associated with trade waste are growing. <br> <br>
        Your process wastewater is successfully treated while operating expenses and maintenance time are kept to a minimum with an appropriate, well-designed system. Our solutions are built to be cost-efficient, small, and minimal maintenance. By offering remote assistance and/or on-site service, our professionals also assist you in maintaining the maximum functioning of your industrial wastewater system long after installation. <br> <br>
    </p>
