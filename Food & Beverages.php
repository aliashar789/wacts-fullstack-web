...
<body>
  ...
  <div class="" id="sub-about">
    ...
    <h1 class="mb-5">Water treatment for the food and beverage sector is a specialty of WACTS.</h1>
    <p>For business owners in the food and beverage sector, managing wastewater may be challenging. Finding a cost-efficient and workable solution might be difficult because to the tightening discharge limitations and the resulting growing trade waste expenses. <br> <br>
        With the aid of our wastewater treatment systems, you can: <br><br>
        1- Suspended solids (SS) <br>
        2- Fats, oils and grease (FOG) <br>
        3- Biochemical oxygen demand (BOD) <br>
        4- Chemical oxygen demand (COD)
    </p>
    <p>WACTS is an Australian company that designs, produces, and delivers wastewater treatment systems. The whole treatment process may be handled internally by our team of engineers, from consultation and 3D CAD design through production, installation, and continuing maintenance. <br><br>
        We provide both pre-packaged goods and custom-designed solutions using the proprietary DAF and MBBR technologies to meet a variety of wastewater treatment needs. <br><br>
        Additionally, WACTS provides competitive contracts for system maintenance and chemical supply.
    </p>
</div>
  </div>
