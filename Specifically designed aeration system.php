...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg " id="nav">
    ...
    <div class="callout">
      <h1 class="text-light sub-callout">
        Specifically designed aeration <br> system
    </h1>
    </div>
  </section>
  <div class="" id="sub-about">
    ...
    <p>Aeration is the process of circulating, mixing, or dissolving liquids or substances with air.
        Aeration brings water and air into intimate contact  to remove dissolved gases and oxidize dissolved metals such as iron, hydrogen sulfide, and volatile organic chemicals (VOCs). This process is usually the first major process in drinking water treatment plants and takes place in the post-treatment process of activated sludge treatment in sewage treatment plants. A uniform supply of oxygen to the aeration system is essential for effective wastewater treatment that promotes microbial growth. <br><br>
        Aeration efficiency  depends on the amount of surface contact between air and water. This is mainly controlled by the droplet or bubble size. Aeration brings water and air into intimate contact by exposing droplets or a thin layer of water to the air or by introducing small air bubbles to rise through the water. Dissolved gases are then removed from the solution and vented to  the surrounding air. 
    </p>
    <h1 class="mb-5 mt-5">PROCESS</h1>
    <p>Aeration is an activated sludge process that promotes microbial growth in wastewater. The microbes then feed on the organic matter and form easily colonized swarms. The bacteria that make up the "activated sludge" flocs that settle  in a separate sedimentation tank are continuously returned to the aeration tank for a higher decomposition rate. <br> <br>
        In industrial applications, waterfall aeration using spray nozzles is the most common  aeration method. There is also an air diffusion method  in which air is diffused into a receiving tank containing countercurrent water.  Aeration is used in liquids, soils and food to improve quality and reduce contamination. This process is used to oxidize soluble iron and manganese to insoluble precipitates. Aeration can also reduce ammonia and hydrogen sulfide, which is great for controlling bacteria.
    </p>
    <img class="w-100" src="images-2/2.png" alt="">
</div>
  </div>
