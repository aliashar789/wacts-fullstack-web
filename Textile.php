...
<body>
  ...
  <div class="" id="sub-about">
    ...
    <h1 class="mb-5">Operations for wastewater treatment in the textile sector that can help you save time and money.</h1>
    <p>Water use in textile production facilities is significant. Since the polluted wastewater is frequently concentrated, municipal wastewater treatment facilities are put under a lot of strain. The majority of authorities will impose tight limitations on the industry's wastewater outflow. <br><br>
        Our knowledge of the pollutants present in textile wastewater enables us to build a compliance solution for your company and open up possibilities for wastewater reuse, saving you money on trade waste fees as well as water use expenses. <br> <br>
        After finishing a significant project in Sydney where the manufacturing plant was not linked to the sewage system, we have a better understanding of the intricacies of inks and dyes in wastewater. The extremely polluted process effluent had to be cleaned to a level that was appropriate for release, according to the local authorities. In order to create a closed loop recycling system, we cleaned this inky wastewater to a quality sufficient not only for irrigation reasons but also for reuse in the starch composition and the boiler feed.
    </p>
